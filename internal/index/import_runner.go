...
func (r *DefaultImportRunner) Run(ctx context.Context, repo, commit, graphPath string, rewriteAll bool) (*importer.Summary, error) {
	return importer.Run(ctx, r.Client, importer.Options{Repo: repo, Commit: commit, GraphPath: graphPath, RewriteAll: rewriteAll})
}
